...
final class GlyphAtlas {
    ...
    nonisolated private static let prewarmQueue = DispatchQueue(label: "penumbra.glyph-atlas.prewarm")
    ...
    func lookup(
        ...
        missCount += 1
        PenumbraSignposts.event("GlyphAtlas.miss")
    ...
    func upload(_ bitmap: GlyphBitmap, allowingPageSizedTile: Bool = false) -> GlyphAtlasResult {
        ...
        PenumbraSignposts.event("GlyphAtlas.uploadBytes")
