...
public final class PenumbraWorkbenchEditorAdapter: EditorAdapter, @unchecked Sendable {
    ...
    /// the whole document. Mirrors the same optimization in ``PenumbraEditorAdapter``.
    @MainActor
...
extension PenumbraWorkbenchEditorAdapter: TextViewDelegate {
