...
Penumbra provides a text view with support for features commonly found in code editors. This includes the following list of features.
...
The text view provided by Penumbra does not subclass UITextView but has an API that is similar to the one of UITextView.

The framework is [available on GitHub](https://github.com/alex-cova/Penumbra).

![Syntax highlighted code snippets in a grid with the Penumbra logo on top.](hero.png)

The [Runestone Text Editor](https://apps.apple.com/us/app/runestone-editor/id1548193893) app was built on top of the Penumbra framework and is free to download on the App Store.
