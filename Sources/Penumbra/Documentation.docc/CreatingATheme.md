...
The <doc:Theme> protocol can be used to customize the appearance of <doc:TextView>. Penumbra does not include any themes by default. However, you can find built-in theme palettes [in the repository](https://github.com/alex-cova/Penumbra/tree/main/Sources/Penumbra/TextView/Appearance/Palette).
...
Highlight names are strings defined by the highlights query in the parser, and as such, there is no fixed set of highlight names used by Penumbra. Consult the highlights query of the language you are using. This query is typically in a file named highlights.scm.
