...
public enum TreeSitterPerformanceConstants {
    ...
    public static let longParseNotification = Notification.Name("Penumbra.longParseNotification")
    public static let longParseFinishedNotification = Notification.Name("Penumbra.longParseFinishedNotification")
}
